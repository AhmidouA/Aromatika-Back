...
const oilController = {
  ...
  async getOilById(req, res) {
    ...
    try {
      ...
      console.error(chalk.bgRedBright(`Erreur lors de l'envoi de l'huile: ${err.message}`));
  ...
  async createOil(req, res) {
    ...
    try {
      ...
      console.error(chalk.bgRedBright(`Erreur lors de la creation de l'huile: ${err.message}`));
  ...
  async updateOilById(req, res) {
    ...
    const {name,botanic_name,description,extraction,molecule,plant_family,scent,image,} = req.body;
    console.log(chalk.bgBlue("{ req Body }>>>>>>", Object.values({name,botanic_name,description,extraction,molecule,plant_family,
      scent,image,})));
    ...
    try {
      ...
      console.error(chalk.bgRedBright(`Erreur lors de la modification de l'huile: ${err.message}` + 'l\'id ' + id ));
  ...
  async deleteOilById(req, res) {
    ...
    try {
      ...
      console.error(chalk.bgRedBright('Erreur lors de la suppression de l\'huile avec l\'id: ' + oilId));
